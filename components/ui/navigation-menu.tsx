...
>(({ className, ...props }, ref) => (
  <NavigationMenuPrimitive.Content
    ref={ref}
    className={cn(
      "data-[motion^=from-]:animate-in data-[motion^=from-]:fade-in data-[motion^=from-]:slide-in-from-top-2 data-[motion^=to-]:animate-out data-[motion^=to-]:fade-out data-[motion^=to-]:slide-out-to-top-2 left-0 top-0 w-full md:absolute md:w-auto",
      className,
    )}
    {...props}
  />
